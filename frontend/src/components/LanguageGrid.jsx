...
const LanguageGrid = () => {
    ...
    const getButtonStyle = (isSelected) => ({
        boxShadow: isSelected
            ? `${CONFIG.PRESSED_SHADOW_TOP}, ${CONFIG.PRESSED_SHADOW_BOTTOM}, ${CONFIG.PRESSED_OUTER_SHADOW.replace('0.2', CONFIG.SHADOW_OPACITY)}`
            : CONFIG.UNPRESSED_SHADOW.replace('0.1', CONFIG.SHADOW_OPACITY),
    ...
    return (
        <div
            ...
            style={{ width: `${CONFIG.GRID_WIDTH}px` }}
        >
