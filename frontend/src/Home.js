...
import LevelIcon from './resources/level.png'; // Corrected import for level icon
...
const Home = () => {
    ...
    const handlePlayClick = () => {
        // Navigate to LevelLoader with a sample levelId (replace '1' with dynamic ID if needed)
        navigate('/level?id=1');
    };
